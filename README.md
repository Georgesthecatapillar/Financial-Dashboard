...
- [ ] Connexion à une API de données en temps réel
- [ ] Automates GitHub Actions pour mise à jour quotidienne
- [ ] Analyse technique supplémentaire
- [ ] Export de rapports
- [ ] Alertes personnalisées

## ❓ FAQ

**Q : Comment puis-je utiliser mes propres données ?**
A : Remplacez les fichiers CSV et mettez à jour les URLs dans `main.py`, ou utilisez une source de données directement.

**Q : Pourquoi certaines données ne s'affichent pas ?**
A : Vérifiez que les fichiers CSV sont présents sur GitHub et que les URLs sont correctes dans le code.

**Q : Comment partager mon dashboard avec d'autres ?**
A : Vous pouvez le déployer gratuitement sur [Streamlit Cloud](https://streamlit.io/cloud).
